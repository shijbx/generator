...
public class CodeGeneration {
    ...
    public static final String path = FileUtils.readYml("gencode.outputUrl");
    ...
    private static void getAllSetting(GlobalConfig gc) {
        ...
        gc.setAuthor(FileUtils.readYml("gencode.author")); // 作者
    }
    ...
    private static void getPolicConfig(AutoGenerator mpg) {
        ...
        // 自定义实体父类
        strategy.setSuperEntityClass(FileUtils.readYml("gencode.superEntityClass"));
        String uperEntityColumns = FileUtils.readYml("gencode.uperEntityColumns");
        // 自定义实体，公共字段
